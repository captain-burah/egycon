                       ...
                       <div class="col-xl-12">
                            <div class="row d-flex justify-content-between align-items-center">
                                <div class="header-info-left">
                                    <ul>     
                                        <li><a href="tel:+97143881856" style="color: #fff !important;" rel="nofollow" title="Call Us">(+971) 4 388 1856</a></li>
                                        <li><a href="mailto:info@egycontracting.com" style="color: #fff !important;" rel="nofollow" title="Email Us">info@egycontracting.com</a></li>
                                        <li>Mon - Sat 9:00 - 18:00</li>
                                    </ul>
                                </div>
                                <div class="header-info-right">
                                    <ul class="header-social">    
                                        <li><a href="https://www.facebook.com/people/Egycon-Contracting/100089927895882/" rel="nofollow" title="Our Instgram" target="_blank"><i class="fab fa-instagram"></i></a></li>
                                        <li><a href="https://www.instagram.com/egycondubai/" rel="nofollow" title="Our Facebook" target="_blank"><i class="fab fa-facebook-f"></i></a></li>
                                    </ul>
                                </div>
                            </div>
                       </div>
               ...
               <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/esnaad.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">The Spark by ESNAAD</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of the project "The Spark by ESNAAD" - ESNAAD Developments (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Meydan, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/legends.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">The Legends Townhouses - Damac Hills </h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of "The Legends" project by DAMAC (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Damac Hills, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/4.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Private Villa (G+1)</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of a private villa (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Waraqa, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/mama.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Mama Shelter Residences</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete structure of Mama Shelter Residences (Subcontracting)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/2.webp" alt="egycon-project-image" title="egycon-project-image" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Azrah, Sharjah</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto"> 
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/5.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Wadi Al Shabak, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/akoya2.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Akoya Oxygen - DAMAC Hills 2</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of a separate phase of Akoya Oxygen for DAMAC
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">DAMAC Hills 2, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/1.jpeg" alt="egycon-project-image" title="egycon-project-image" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Private Villas (G+1)</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of Private Villas (G+1) 
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Multiple Locations in Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/vezul.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Vezul Residence</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of Vezul Residence (Subcontracting)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Business Bay, Dubai</p>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/_default.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Iskan Villas</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete structure of Iskan villas for Ali Moosa (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Suyoh, Sharjah</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/3.jpeg" alt="egycon-project-image" title="egycon-project-image" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete construction of a private villa (G+1) for Taha Al Gabri (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Tarfanah, Sharjah</p>
                                        </div>
                                    </div>                            
                                </div>
                              </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                              <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/mada.webp" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                              </div>
                              <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        <div class="p-2">
                                            <h3 class="text-left">Mada Tower</h3>
                                        </div>
                                        <div class="p-2">
                                            <p class="text-left">
                                                A complete structure of Mada Tower (Subcontracting)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Business Bay, Dubai</p>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                            <div class="col-sm-3">
                                <img class="d-block w-100 h-100" src="../assets/img/project/new/6.jpeg" alt="egycon-project-image-01" title="egycon-project-image-01" height="auto" width="auto" loading="lazy">
                            </div>
                            <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="p-2">
                                            <p class="text-left">
                                            A complete construction of a private villa (G+1) for Nasser Al Sheikh (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Mizhar, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                            </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                            <div class="col-sm-3">
                                <img class="d-block w-100  h-100" src="../assets/img/project/new/_default.webp" alt="egycon-project-image-02" title="egycon-project-image-02" height="auto" width="auto" loading="lazy">
                            </div>
                            <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="p-2">
                                            <p class="text-left">
                                            A complete construction of a private villa (G+1) for for Saleem Al Sewidi (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Azrah, Sharjah</p>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                            <div class="col-sm-3">
                                <img class="d-block w-100  h-100" src="../assets/img/project/new/_default.webp" alt="egycon-project-image-03" title="egycon-project-image-03" height="auto" width="auto" loading="lazy">
                            </div>
                            <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="p-2">
                                            <p class="text-left">
                                            A complete construction of a private villa (G+1) for for Abdallah Ahmed Lootah (Main Contractor)
                                            </p>
                                        </div>
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Mamzar, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                            </div>
                            ...
                            <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
                                        ...
                                        <div class="mt-auto p-2">
                                            <p class="m-0">Al Khawaneej, Dubai</p>
                                        </div>
                                    </div>                            
                                </div>
                            </div>
                ...
                <div class="row text-center mx-auto mb-4">
                    <div class="col-md-10 mx-auto">
                        <div class="card shadow-sm">
                            <div class="row">
                            <div class="col-sm-3">
                                <img class="d-block w-100  h-100" src="../assets/img/project/new/_default.webp" alt="egycon-project-image-04" title="egycon-project-image-04" height="auto" width="auto" loading="lazy">
                            </div>
                            <div class="col-sm-9">
                                <div class="card-body h-100">
                                    <div class="d-flex align-items-start flex-column">
