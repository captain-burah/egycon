<?php
    ...
    if(strlen($message) > 200){$empty[] = urlencode("Invalid name length");}
    if(strlen($message) > 200){$empty[] = urlencode("Invalid name length");}
    ...
    if(!empty($empty)) {
        ...
        header("Location: comingsoon_12/index.html?ack_message=".urlencode($output));    
        ...
        if ($curlResponseArray["success"] == true && $curlResponseArray["score"] >= 0.5) {
            ...
            if(mysqli_query($link, $sql)){
                ...
                try {
                    ...
                    $mail->addAddress("ah@egycontracting.com", "EGYCON");                   
                    ...
                    header("Location: comingsoon_12/thankyou.html?ack_message=".urlencode($output));    
                    exit;          
