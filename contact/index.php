...
<html lang="en">
  <head>
    ...
    <!--TITLE & DESCRIPTIONS-->
    <title lang="en-us">Contact Us: Egycon | Your Construction Needs in Dubai</title>
    <meta name="description" content="Get in touch with Egycon Contracting today! We're here to discuss your construction project and answer any questions you may have. Contact us by phone, email, or fill out our online form to schedule a free consultation.">
    <meta name="author" content="Egycon Contracting L.L.C.">
      <link rel="canonical" href="https://egycontracting.com/contact" />
      
      <!-- ESSENTIAL OG TAGS -->
    <meta property="og:title" content="Contact Us: Egycon | Your Construction Needs in Dubai">
    ...
    <meta property="og:description" content="Get in touch with Egycon Contracting today! We're here to discuss your construction project and answer any questions you may have. Contact us by phone, email, or fill out our online form to schedule a free consultation.">
    <meta property="og:site_name" content="Contact Us: Egycon | Your Construction Needs in Dubai">
  ...
  <main id="main">
    ...
    <!-- HEADER -->
    <section style="padding-top: 7vh !important;">
      <header class="desktop_view">
      
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d87198.52619907472!2d55.28349110785287!3d25.167973348250218!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f672d2d72e7bd%3A0x8799aca9e0ca1c97!2sEGYCON%20Contracting!5e0!3m2!1sen!2sae!4v1716793715489!5m2!1sen!2sae" 
          width="100%" height="auto" style="border:0; height: 60vh !important; padding-top: 1vh !important;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          <!-- Background image -->
          <!-- <div
            ...
            class="my-auto"
          >
            <div class="mask p-0 m-0" style="background-color: rgba(0, 0, 0, 0.5); height: 100% !important;">
              <div class="d-flex justify-content-center align-items-center h-100">
                <div class="text-white">
                  <h1 class="mb-3 text-left">We'd love to hear from you</h1>
                </div>
              </div>
            </div>
          </div> -->
      ...
      <header class="mobile_view">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d87198.52619907472!2d55.28349110785287!3d25.167973348250218!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3e5f672d2d72e7bd%3A0x8799aca9e0ca1c97!2sEGYCON%20Contracting!5e0!3m2!1sen!2sae!4v1716793715489!5m2!1sen!2sae" 
          width="100%" height="auto" style="border:0; height: 50vh !important; padding-top: 5vh !important;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </header>
    </section>
    <!-- HEADER -->
          ...
          <div class="col-md-8 mx-auto">
            <div class="info-item d-flex flex-column justify-content-center align-items-center mx-auto text-center">
              ...
              <form class="w-100" action="../contact.php" method="POST" id="contact-form-desktop" >
                ...
                <div class="row">
                  <div class="col-md-5 ">
                      <div class="form-group ">
                          ...
                          <select class="form-control rounded-0" name="country_code" style="color: #000; ;">
                  ...
                  <div class="col-md-7 ">
                      <div class="form-group email">
                          <input type="number" name="phone" id="number" class="form-control rounded-0" style="color: #000;" placeholder="Phone" required="">
                      </div>   
                  </div>
                </div>
                ...
                <button type="button" class="g-recaptcha btn btn-warning rounded-pill text-white w-50" 
    ...
    <!-- FOOTER -->
    <footer class="mt-auto text-light bg-primary">
      <div class="container">
        <div class="row border-b border-white d-flex justify-content-between py-4">
          ...
          <div class="my-auto">
            ...
            <a href="./" class="text-white ml-3">Contact Us</a>
          </div>
        </div>
        <div class="row border-top border-white d-flex justify-content-between py-4">
          ...
          <div >
            <span class="text-white ml-3">© <?php echo date("Y"); ?> Copyright Egycon. All Right Reserved</a>
          </div>
        </div>
      </div>
    </footer>
